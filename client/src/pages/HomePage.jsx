...
const HomePage = () => {
  ...
  const { logout } = useContext(AuthContext); // Destructured as logout
  ...
  return (
    <div className="flex h-screen w-full bg-[#FDFCFE] font-sans text-gray-900 overflow-hidden relative">
      ...
      {/* MOBILE BOTTOM NAV */}
      {/* Changed px-4 to px-2 to ensure 7 buttons sit cleanly without overlapping on narrower screens */}
