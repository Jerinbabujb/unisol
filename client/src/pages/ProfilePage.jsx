  ...
  return (
    <div className="flex min-h-screen bg-[#FDFCFE] font-sans text-gray-900 overflow-x-hidden relative selection:bg-[#5D3289] selection:text-white">
      ...
      <div className="flex-1 flex flex-col items-center py-12 px-4 lg:pl-[120px] pb-32 lg:pb-12 transition-all duration-300">
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-5xl flex flex-col lg:flex-row gap-8 z-10">
          ...
          <div className="flex-[1.6] bg-white/80 backdrop-blur-xl p-8 md:p-10 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#F4F0F9] flex flex-col">
            ...
            <div className="mt-auto flex flex-col-reverse sm:flex-row justify-end items-center gap-4 border-t border-gray-100 pt-8">
              <button onClick={() => navigate('/')} type="button" className="text-gray-500 font-bold px-8 py-4 rounded-2xl hover:bg-gray-50 hover:text-gray-800 transition-all">Discard</button>
        ...
        {/* MOBILE BOTTOM NAV */}
        <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-xl border-t border-[#F4F0F9] px-6 py-4 flex justify-between items-center z-40 shadow-[0_-10px_40px_-10px_rgba(93,50,137,0.1)] safe-area-pb">
          <button onClick={() => navigate('/')} className={`flex flex-col items-center transition-all duration-300 ${location.pathname === '/' ? 'text-[#5D3289] scale-110 drop-shadow-md' : 'text-gray-400 hover:text-gray-600'}`}><svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L2 22l10-3 10 3L12 2z" /></svg></button>
          <button onClick={() => navigate('/friend-request')} className={`flex flex-col items-center transition-all duration-300 ${location.pathname === '/friend-request' ? 'text-[#5D3289] scale-110 drop-shadow-md' : 'text-gray-400 hover:text-gray-600'}`}><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5"><path d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg></button>
          <button onClick={() => navigate('/global-room-lists')} className={`flex flex-col items-center transition-all duration-300 ${location.pathname === '/global-room-lists' ? 'text-[#5D3289] scale-110 drop-shadow-md' : 'text-gray-400 hover:text-gray-600'}`}><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5"><path d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z" /></svg></button>
          <button onClick={() => navigate('/messages')} className={`flex flex-col items-center transition-all duration-300 ${location.pathname === '/messages' ? 'text-[#5D3289] scale-110 drop-shadow-md' : 'text-gray-400 hover:text-gray-600'}`}><svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z" /></svg></button>
          <button onClick={() => navigate('/profile')} className={`flex flex-col items-center transition-all duration-300 ${location.pathname === '/profile' ? 'text-[#5D3289] scale-110 drop-shadow-md' : 'text-gray-400 hover:text-gray-600'}`}><svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" /></svg></button>
        </nav>
