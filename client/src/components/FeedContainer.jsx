        ...
        <div className="flex bg-gray-100/80 p-1 rounded-full">
          {['Discovery', 'Online Now'].map((filter) => (
            <button
              ...
              className={`px-4 py-2 text-xs font-bold rounded-full transition-all duration-300 ${activeFilter === filter ? 'bg-white text-[#5D3289] shadow-sm' : 'text-gray-500 hover:text-gray-800'
                }`}
            >
              {filter}
            </button>
